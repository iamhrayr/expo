...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) BOOL interceptsMotionGestures;)
+ (BOOL)interceptsMotionGestures SWIFT_WARN_UNUSED_RESULT;
+ (void)setInterceptsMotionGestures:(BOOL)newValue;
/// Returns bool value whether the dev menu touch gestures are being intercepted.
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) BOOL interceptsTouchGestures;)
+ (BOOL)interceptsTouchGestures SWIFT_WARN_UNUSED_RESULT;
+ (void)setInterceptsTouchGestures:(BOOL)newValue;
/// Returns bool value whether the dev menu key commands are being intercepted.
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) BOOL interceptsKeyCommands;)
+ (BOOL)interceptsKeyCommands SWIFT_WARN_UNUSED_RESULT;
+ (void)setInterceptsKeyCommands:(BOOL)newValue;
